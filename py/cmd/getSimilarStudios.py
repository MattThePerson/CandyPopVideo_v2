"""
Looks up similar studios for a target name using a pre-built studio profiles matrix.

Usage:
    python -m cmd.getSimilarStudios --model-path <path/to/studio_profiles.pkl> --target "acme studios"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model-path', required=True, help='Path to studio_profiles.pkl')
    parser.add_argument('--target', required=True, help='Target studio name')
